(function ($) {
  ...
  if ($(".img-popup ,.popup-gallery").length) {
    var groups = {};
    $(".img-popup, .popup-gallery").each(function () {
  ...
  $(".main-slider-one__trigger").on("click", function (e) {
    e.preventDefault();
    $("html, body").animate(
      {
  ...
  function drivschol_cuved_circle() {
